...
class OODCVVQAEval:
    ...
    def evaluate(self, counter_factual=False):
        ...
        with open('misclassified_images_final.json', 'w') as json_file:
            json.dump(misclassified_images, json_file)
        print(f"Misclassified images saved to 'misclassified_images_final.json'.")
